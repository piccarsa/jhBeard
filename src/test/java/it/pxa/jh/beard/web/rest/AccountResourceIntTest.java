package it.pxa.jh.beard.web.rest;

import it.pxa.jh.beard.config.Constants;
import it.pxa.jh.beard.JhBeardApp;
import it.pxa.jh.beard.domain.Authority;
import it.pxa.jh.beard.domain.User;
import it.pxa.jh.beard.repository.AuthorityRepository;
import it.pxa.jh.beard.repository.UserRepository;
import it.pxa.jh.beard.security.AuthoritiesConstants;
import it.pxa.jh.beard.service.MailService;
import it.pxa.jh.beard.service.dto.UserDTO;
import it.pxa.jh.beard.web.rest.errors.ExceptionTranslator;
import it.pxa.jh.beard.web.rest.vm.KeyAndPasswordVM;
import it.pxa.jh.beard.web.rest.vm.ManagedUserVM;
import it.pxa.jh.beard.service.UserService;
...
@SpringBootTest(classes = JhBeardApp.class)
